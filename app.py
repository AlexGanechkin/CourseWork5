...
def choose_hero():
    if request.method == "POST":
        ...
        weapon = Equipment().get_weapon(weapon_name=hero_weapon)
        armor = Equipment().get_armor(armor_name=hero_armor)
...
def choose_enemy():
    if request.method == "POST":
        ...
        weapon = Equipment().get_weapon(weapon_name=enemy_weapon)
        armor = Equipment().get_armor(armor_name=enemy_armor)
